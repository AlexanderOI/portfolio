...
import { ReactIcon, ReactRouterIcon, StyledComponentsIcon, TypeScriptIcon } from "../../assets/icons/SkillsIcons"
    ...
    <>
      {languagePage === 'es' ?
        <Details>
          ...
          <div >
            <h2>Dentsuzu Shop</h2>
            <p>Proyecto desarrollado con la intención de mejorar mis habilidades de Desarrollo Front-End con React y TypeScript</p>
        ...
        <Details>
          ...
          <div >
            <h2>Dentsuzu Shop</h2>
            <p>Project developed with the intention of improving my Front-End Development skills with React and TypeScript</p>
            ...
            <p >
              <b>Side menu for supermarket sections: </b>This bar allows users to quickly navigate to specific supermarket sections to view specific products, such as bakery, meat, dairy, etc.
            </p>
            <p>
              <b>Filtering by name, category, and price: </b>Users can filter products by different criteria to quickly access the desired product.
            </p>
            <p>
              <b>Product search by name: </b>Users can search for specific products by typing the name in a search field.
            </p>
            <p>
              <b>Numeric product pagination (28 per page): </b>Numeric pagination is used to manage large product lists.
            </p>
            <p>
              <b>Shopping cart: </b>The page includes a shopping cart that displays the products selected by the user, quantity, and total price. Users can add and remove products from their cart and review their purchases before completing the purchase.
            </p>
