    ...
    <>
      {languagePage === 'es' ?
        <Details>
          ...
          <div >
            <h2>Database CRUD</h2>
            <p>Proyecto desarrollado como práctica de Python con PyQt5. Es un proyecto que simula un CRUD de base de datos, permitiendo gestionar productos de forma básica.</p>

            <h4>Tecnologias utilizadas</h4>
            <ul>
              <li><PythonIcon />Python</li>
              <li><Pyqt5Icon />PyQt5</li>
              <li><QtDesignerIcon />Qt Designer</li>
              <li><SQLiteIcon />SQLite</li>
            </ul>

            <h4>Caracteristicas</h4>
            <p >
              <b>Visualización de la base de datos en tablas: </b>Los usuarios pueden ver los datos almacenados en la base de datos en un formato de tabla.
            </p>
            <p>
              <b>Registro de un nuevo elemento: </b>Los usuarios pueden agregar nuevos elementos a la base de datos completando un formulario.
            </p>
            <p>
              <b>Actualización de los datos:  </b>Los usuarios pueden buscar un elemento existente en la base de datos utilizando su nombre, para luego modificar sus datos.
            </p>
            <p>
              <b>Eliminación de un elemento:   </b>Los usuarios pueden buscar un elemento por su nombre, para luego poder eliminarlo de la base de datos.
            </p>
        ...
        <Details>
          ...
          <div >
            <h2>Database CRUD</h2>
            <p>Project developed as a Python practice with PyQt5. It is a project that simulates a database CRUD, allowing basic product management.</p>
            ...
            <p >
              <b>Database Visualization in Tables: </b>Users can view the data stored in the database in a table format.
            </p>
            <p>
              <b>Adding a New Item: </b>Users can add new items to the database by completing a form.
            </p>
            <p>
              <b>Data Update: </b>Users can search for an existing item in the database using its name, and then modify its data.
            </p>
            <p>
              <b>Item Deletion: </b>Users can search for an item by its name and then delete it from the database.
            </p>
